...
const CAMPAIGN = [
  ...
  },
  {
    ...
    enemies: [
      { job: 'leviathan', level: 23, x: 6, y: 5 },
      { job: 'drownedKnight', level: 22, x: 3, y: 2, name: 'Tessaly Guard' },
      { job: 'drownedKnight', level: 22, x: 9, y: 2, name: 'Tessaly Guard' },
      { job: 'drownedKnight', level: 23, x: 6, y: 1, name: 'Captain of the Watch' },
      { job: 'siren', level: 22, x: 2, y: 6 },
      { job: 'saltPriest', level: 22, x: 10, y: 6, name: 'Drowned Cantor' },
      { job: 'reefCrab', level: 22, x: 4, y: 3 },
    ],
    gil: 6800,
    outro: [
