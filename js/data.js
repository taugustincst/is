...
const JOBS = {
  ...
  namelessCold: {
    ...
    hp: 2.5, mp: 2.5, pa: 1.5, ma: 1.7, spd: 1.05, move: 5, jump: 9, evade: 12,
...
const CAMPAIGN = [
  ...
  },
  {
    ...
    enemies: [
      { job: 'winterRegent', level: 16, x: 6, y: 3, name: 'The Winter Regent', boss: true,
        passives: ['counter', 'magickUp', 'movePlus1'],
        phases: [{
          atPct: 0.4, job: 'namelessCold', name: 'The Nameless Cold', heal: 0.75,
          passives: ['counter', 'magickUp', 'movePlus1'],
      ...
      { job: 'hollowKnight', level: 15, x: 4, y: 4 },
      { job: 'hollowKnight', level: 15, x: 8, y: 4 },
      { job: 'rimeWight', level: 15, x: 3, y: 6 },
      { job: 'rimeWight', level: 15, x: 9, y: 6 },
      { job: 'frostweaver', level: 15, x: 6, y: 2, name: 'Regent\'s Weaver' },
    ],
    gil: 10000,
    outro: [
