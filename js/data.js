...
const CAMPAIGN = [
  ...
  },
  {
    ...
    enemies: [
      { job: 'saltPriest', level: 21, x: 5, y: 2, name: 'The Prior', boss: true, passives: ['magickUp', 'absorbMp', 'movePlus1'] },
      { job: 'saltPriest', level: 19, x: 4, y: 3, name: 'Cantor' },
      { job: 'drownedKnight', level: 20, x: 3, y: 4, name: 'Chapel Warden' },
      { job: 'drownedKnight', level: 20, x: 7, y: 4, name: 'Chapel Warden' },
      { job: 'siren', level: 19, x: 2, y: 2 },
      { job: 'siren', level: 19, x: 8, y: 3 },
    ],
    gil: 6200,
  ...
  },
  {
    ...
    enemies: [
      { job: 'leviathan', level: 22, x: 6, y: 5 },
      { job: 'drownedKnight', level: 21, x: 3, y: 2, name: 'Tessaly Guard' },
      { job: 'drownedKnight', level: 21, x: 9, y: 2, name: 'Tessaly Guard' },
      { job: 'drownedKnight', level: 22, x: 6, y: 1, name: 'Captain of the Watch' },
      { job: 'siren', level: 21, x: 2, y: 6 },
      { job: 'saltPriest', level: 21, x: 10, y: 6, name: 'Drowned Cantor' },
      { job: 'reefCrab', level: 21, x: 4, y: 3 },
    ],
    gil: 6800,
    outro: [
  ...
  },
  {
    ...
    enemies: [
      { job: 'drownedQueen', level: 23, x: 6, y: 5, name: 'The Drowned Queen', boss: true,
        passives: ['counter', 'magickUp', 'movePlus1'],
        phases: [{
      ...
      { job: 'drownedKnight', level: 22, x: 3, y: 3, name: 'Queen\'s Guard' },
      { job: 'drownedKnight', level: 22, x: 9, y: 3, name: 'Queen\'s Guard' },
      { job: 'siren', level: 22, x: 2, y: 6 },
      { job: 'siren', level: 22, x: 10, y: 6 },
      { job: 'saltPriest', level: 22, x: 6, y: 2, name: 'Queen\'s Cantor' },
      { job: 'leviathan', level: 22, x: 8, y: 9, name: 'The Old Serpent' },
    ],
    gil: 14000,
    outro: [
