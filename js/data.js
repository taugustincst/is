...
const ITEMS = {
  ...
  marshalsBlade: { name: 'Marshal\'s Blade', late: true, slot: 'weapon', wtype: 'sword', power: 21, range: 1, vert: 2, pa: 2, price: 4400, tier: 7 },
  rodOfOffice:   { name: 'Rod of Office', late: true, slot: 'weapon', wtype: 'rod', power: 8, range: 1, vert: 2, ma: 11, resist: { holy: 'resist' }, price: 4200, tier: 7 },
  rapier:        { name: 'Rapier', slot: 'weapon', wtype: 'sword', power: 13, range: 1, vert: 2, spd: 1, evade: 6, price: 2200, tier: 6 },
  regentsPlate:  { name: 'Regent\'s Plate', late: true, slot: 'body', atype: 'heavy', hp: 76, pa: 1, price: 4600, tier: 7 },
  griffonMantle: { name: 'Griffon Mantle', late: true, slot: 'body', atype: 'light', hp: 56, jump: 2, evade: 6, price: 4200, tier: 7 },
  golemHeart:    { name: 'Golem Heart', late: true, slot: 'acc', hp: 40, resist: { earth: 'absorb' }, price: 3800, tier: 7 },
  sealOfOffice:  { name: 'Seal of Office', late: true, slot: 'acc', ma: 3, mp: 30, wards: ['silence'], price: 4000, tier: 7 },
  courtBlade:    { name: 'Court Blade', city: 'elderonCity', slot: 'weapon', wtype: 'sword', power: 16, range: 1, vert: 2, ma: 2, price: 2900, tier: 6 },
  kingsGuardHelm:{ name: 'King\'s Guard Helm', city: 'elderonCity', late: true, slot: 'head', htype: 'helm', look: 'helm', hp: 44, pa: 2, price: 3900, tier: 7 },
  leagueCoat:    { name: 'League Coat', city: 'aldermere', slot: 'body', atype: 'light', hp: 52, mp: 20, price: 2700, tier: 6 },
  charterRing:   { name: 'Charter Ring', city: 'aldermere', late: true, slot: 'acc', pa: 2, ma: 2, evade: 4, price: 4000, tier: 7 },
