...
const CAMPAIGN = [
  ...
  },
  {
    ...
    enemies: [
      { job: 'drownedKnight', level: 18, x: 6, y: 3, name: 'Drowned Mate' },
      { job: 'drownedKnight', level: 18, x: 9, y: 4, name: 'Drowned Bosun' },
      { job: 'siren', level: 18, x: 8, y: 5 },
      { job: 'siren', level: 18, x: 5, y: 6 },
      { job: 'saltPriest', level: 19, x: 7, y: 2, name: 'Priory Cantor' },
      { job: 'reefCrab', level: 18, x: 10, y: 5 },
    ],
    gil: 5600,
    outro: [
  ...
  },
  {
    ...
    enemies: [
      { job: 'saltPriest', level: 22, x: 5, y: 2, name: 'The Prior', boss: true, passives: ['magickUp', 'absorbMp', 'movePlus1'] },
      { job: 'saltPriest', level: 20, x: 4, y: 3, name: 'Cantor' },
      { job: 'drownedKnight', level: 21, x: 3, y: 4, name: 'Chapel Warden' },
      { job: 'drownedKnight', level: 21, x: 7, y: 4, name: 'Chapel Warden' },
      { job: 'siren', level: 20, x: 2, y: 2 },
      { job: 'siren', level: 20, x: 8, y: 3 },
    ],
    gil: 6200,
  ...
  },
  {
    ...
    enemies: [
      { job: 'leviathan', level: 24, x: 6, y: 5 },
      { job: 'drownedKnight', level: 23, x: 3, y: 2, name: 'Tessaly Guard' },
      { job: 'drownedKnight', level: 23, x: 9, y: 2, name: 'Tessaly Guard' },
      { job: 'drownedKnight', level: 24, x: 6, y: 1, name: 'Captain of the Watch' },
      { job: 'siren', level: 23, x: 2, y: 6 },
      { job: 'saltPriest', level: 23, x: 10, y: 6, name: 'Drowned Cantor' },
      { job: 'reefCrab', level: 23, x: 4, y: 3 },
    ],
    gil: 6800,
    outro: [
