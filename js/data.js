...
const CAMPAIGN = [
  ...
  },
  {
    ...
    enemies: [
      { job: 'drownedKnight', level: 19, x: 6, y: 3, name: 'Drowned Mate' },
      { job: 'drownedKnight', level: 19, x: 9, y: 4, name: 'Drowned Bosun' },
      { job: 'siren', level: 19, x: 8, y: 5 },
      { job: 'siren', level: 19, x: 5, y: 6 },
      { job: 'saltPriest', level: 20, x: 7, y: 2, name: 'Priory Cantor' },
      { job: 'reefCrab', level: 19, x: 10, y: 5 },
    ],
    gil: 5600,
    outro: [
  ...
  },
  {
    ...
    enemies: [
      { job: 'saltPriest', level: 23, x: 5, y: 2, name: 'The Prior', boss: true, passives: ['magickUp', 'absorbMp', 'movePlus1'] },
      { job: 'saltPriest', level: 21, x: 4, y: 3, name: 'Cantor' },
      { job: 'drownedKnight', level: 22, x: 3, y: 4, name: 'Chapel Warden' },
      { job: 'drownedKnight', level: 22, x: 7, y: 4, name: 'Chapel Warden' },
      { job: 'siren', level: 21, x: 2, y: 2 },
      { job: 'siren', level: 21, x: 8, y: 3 },
    ],
    gil: 6200,
...
const ITEMS = {
  ...
  kaiserKnuckles:{ name: 'Kaiser Knuckles', late: true, slot: 'weapon', wtype: 'fist', power: 20, range: 1, vert: 3, spd: 1, price: 4000, tier: 7 },
  ...
  artemisBow:    { name: 'Artemis Bow', late: true, slot: 'weapon', wtype: 'bow', power: 16, range: 6, vert: 8, evade: 4, price: 4000, tier: 7 },
  ...
  lamiaHarp:     { name: 'Lamia Harp', late: true, slot: 'weapon', wtype: 'harp', power: 9, range: 4, vert: 4, ma: 9, mp: 30, price: 4000, tier: 7 },
  ...
  kogaBlade:     { name: 'Koga Blade', late: true, slot: 'weapon', wtype: 'ninjablade', power: 15, range: 1, vert: 2, spd: 2, evade: 6, price: 4000, tier: 7 },
  ...
  rodOfZeus:     { name: 'Rod of Zeus', late: true, slot: 'weapon', wtype: 'rod', power: 8, range: 1, vert: 2, ma: 12, resist: { thunder: 'absorb' }, price: 4000, tier: 7 },
  ...
  zeusDagger:    { name: 'Dagger of Zeus', late: true, slot: 'weapon', wtype: 'knife', power: 12, range: 1, vert: 2, spd: 2, evade: 6, price: 4000, tier: 7 },
  ...
  slasher:       { name: 'Slasher', late: true, slot: 'weapon', wtype: 'axe', power: 22, range: 1, vert: 2, pa: 2, price: 4000, tier: 7 },
